...
export const emailOtpHtmlTemplate = (
  ...
  <div style="font-family: Arial, sans-serif; font-size: 15px; color: #333;">
    ...
    <p>Use the following One-Time Password (OTP) to <strong>${user ? 'sign in' : 'sign up'}</strong> to <b>${appName}</b>:</p>
    ...
    <p style="font-size: 13px; color: #555;">This OTP is valid for 5 minutes. Do not share it with anyone.</p>
  </div>
`;
